...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'about.story.p1', label: 'Paragraph 1', multiline: true },
      { key: 'about.story.p2', label: 'Paragraph 2', multiline: true },
      { key: 'about.story.p3', label: 'Paragraph 3', multiline: true },
      { key: 'about.story.p4', label: 'Paragraph 4', multiline: true },
      { key: 'about.story.p5', label: 'Paragraph 5', multiline: true },
      { key: 'about.story.p6', label: 'Paragraph 6', multiline: true },
      { key: 'about.story.p7', label: 'Paragraph 7', multiline: true },
